...
const SignUpPage = () => {
  return (
    <>
      ...
      <form className="mt-8 space-y-5 sm:grid-cols-2">
        ...
        <div>
          ...
          <input
            id="signup-password"
            type="password"
            placeholder="A strong 12+ character password should mix uppercase/lowercase letters, numbers, and special characters (!@#$%^&*)"
